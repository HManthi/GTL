  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="form-group">
          ...
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Game Date:</label>
            <input type="text" class="form-control" id="game_date" name="game_date">
          </div>
      </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\XAMPP\htdocs\runner\resources\views/admin/tbm_form_data.blade.php ENDPATH**/ ?>